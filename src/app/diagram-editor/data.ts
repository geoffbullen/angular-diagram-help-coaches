...
export let  kanbanNode: NodeModel = {
  ...
  height: 1000,
  shape: { type: "HTML" },
  constraints: (NodeConstraints.Default | NodeConstraints.AllowDrop) & ~(NodeConstraints.Rotate)
}

export let node1: NodeModel = {
  addInfo: {
    type: 'sticky', jiraData: {
      "typeIconUrl": "https://wallsync-addons.atlassian.net/secure/viewavatar?size=medium&avatarId=10318&avatarType=issuetype",
  ...
  annotations: [
    { content: 'This is a thing of less than beauty' }
  ],
  id: `XXX`,
  width: 100,
  offsetX: 200,
